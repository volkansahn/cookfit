...
class ListTextTile extends StatelessWidget {
  ...
  const ListTextTile(
      {Key? key, required this.title, this.subtitle, this.subtitleColor})
      : super(key: key);
      ...
      child: Padding(
        ...
        child: Text(
          ...
          style: theme.textStyle
              .copyWith(color: subtitleColor ?? CupertinoColors.systemGrey2),
        ),
      ),
    );
  }
          ...
          Expanded(
            child: Text(
              ...
              style: titleColor != null
                  ? theme.actionTextStyle.copyWith(color: titleColor)
                  : null,
            ),
          ),
          Spacer(),
